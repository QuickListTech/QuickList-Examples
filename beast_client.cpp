...
int main(int argc, char** argv)
{
    ...
    ctx.use_certificate_file("crypto/client/client.cert.pem", ssl::context::file_format::pem);
    ctx.use_private_key_file("crypto/client/client.key.pem", ssl::context::file_format::pem);
